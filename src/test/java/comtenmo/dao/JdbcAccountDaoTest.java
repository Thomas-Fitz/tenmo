...
public class JdbcAccountDaoTest extends BaseDaoTests {
    ...
    public void testGetBalanceByUserId(){
        ...
        assertEquals(new BigDecimal("1000.00"), accountDao.getBalanceByUserId(user.getId()));
    }
    ...
    public void addToBalanceTest(){
        ...
        assertEquals(initialBalance.add(amountToAdd), accountDao.getBalanceByUserId(userId));
    }
    ...
    public void subtractFromBalanceTest(){
        ...
        assertEquals(initialBalance.subtract(amountToSubtract), accountDao.getBalanceByUserId(userId));
    }
